...
### Phase 1: Core VM Management (docs/00-11)
...
| [11-bootable-oci-build.md](./11-bootable-oci-build.md) | Building Bootable OCI Images | Implemented | Guidance on building custom OCI images that satisfy the Boot Contract |

### Phase 2: Advanced Features (docs/12-13, 15-16)
...
The `future/` directory contains feature request specifications for Phase 2 features that do **not** yet have numbered design documents. Once a feature is promoted to a numbered doc, its future/ entry is removed.
