...
func TestDerivedPathHelpers(t *testing.T) {
	...
	tests := []struct {
		...
		{"OCIRuntimeEntryDir", cfg.OCIRuntimeEntryDir("abc123"), "/var/lib/cocoon/cache/oci/runtime/abc123"},
		{"OCIRuntimeRootfsDir", cfg.OCIRuntimeRootfsDir("abc123"), "/var/lib/cocoon/cache/oci/runtime/abc123/rootfs"},
