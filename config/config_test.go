...
func TestDerivedPathHelpers(t *testing.T) {
	...
	tests := []struct {
		...
		{"OCIRuntimeCacheDir", cfg.OCIRuntimeCacheDir(), "/var/lib/cocoon/cache/oci/runtime"},
		{"OCIRuntimeLayersDir", cfg.OCIRuntimeLayersDir(), "/var/lib/cocoon/cache/oci/runtime/layers"},
		{"OCIRuntimeLayerDir", cfg.OCIRuntimeLayerDir("abc123"), "/var/lib/cocoon/cache/oci/runtime/layers/abc123"},
		{"OCIRuntimeEntriesDir", cfg.OCIRuntimeEntriesDir(), "/var/lib/cocoon/cache/oci/runtime/entries"},
		{"OCIRuntimeEntryDir", cfg.OCIRuntimeEntryDir("abc123"), "/var/lib/cocoon/cache/oci/runtime/entries/abc123"},
		{"OCIRuntimeEntryMetaPath", cfg.OCIRuntimeEntryMetaPath("abc123"), "/var/lib/cocoon/cache/oci/runtime/entries/abc123/meta.json"},
...
func TestEnsureDirs(t *testing.T) {
	...
	expectedDirs := []string{
		...
		cfg.OCIBlobDir(),
		cfg.OCILayoutDir(),
		cfg.OCIRuntimeLayersDir(),
		cfg.OCIRuntimeEntriesDir(),
		cfg.VMDir(),
		cfg.TempDir(),
		cfg.FirmwareDir(),
